...
public class Singlerecordcompare_RESTAPI_RestAssured {

	RestassuredES res = new RestassuredES();
	
	@Test
	public void singleRecordValidation_RestAssured() throws IOException, SQLException
	{
		...
		int sqlpopulation = 0;
		String Query="Select * from city where Population='119401'";
		...
		/*******************************************Elastic search********************************************/
		String QueryREST="{\"query\":{\"bool\":{\"must\":[{\"term\":{\"Population\":\"119401\"}}],\"must_not\":[],\"should\":[]}},\"from\":0,\"size\":10,\"sort\":[],\"aggs\":{}}";
		System.out.println();
		String strAllresponse = res.rest(QueryREST);
		int ESID = 0;
		String ESName = null;
		...
		if(totalHitsize==0)
		{
			System.out.println("Record not present...in ES");
		}
		else
		{
			...
			for(int i =0;i<ES_hits.size();i++)
			{
				...
				try
				{
					...
					System.out.println();
					System.out.println("Elastic search record:"+ESID+"  "+ESName+"  "+EScountrycode+"  "+ESDistrict+"  "+ESpopulation);
					System.out.println();
				}
				catch(Exception e)
				{
